...
import { IGoingBlastPresale } from "./IGoingBlastPresale.sol";
...
contract GoingBlastPresale is IGoingBlastPresale, Ownable {
	...
	/**
	 * @notice Call this function to finalize a successful presale. Calling this function will provide liquidity
	...
	function _prevalidatePool(PresaleOptions memory _options) internal view returns (bool) {
		...
		if (_options.liquidityBps > 10000) revert InvalidLiquidityValue();
